...
User stories were the most useful concept for our project because they helped us focus on what international students actually need in Germany. They showed us how features like accommodation guidance, visa support, banking help, and German language assistance can solve real student problems. This made our app more practical and user-centered
...
Initially, we thought most international students would be comfortable using English and digital platforms. However, after creating the personas and scenarios, we understood that many students may struggle with language differences, cultural adjustment, and complicated systems in Germany. Because of this, we focused more on making the app simple, easy to understand, and supportive through multilingual options and step-by-step guidance.
